        ...
        for u in self.graph.keys():
            ...
            for v in self.graph[u]:
                ...
                for start in self.start_probabilities.keys():
                    self.transition_probabilities[u][v] += self.total_starts
...
while(True):
    ...
    for file in files:
        ...
        word_graph = create_word_graph(filtered_text, questions)
