...
def fit(text, n):
    ...
    for i in range(len(words) - 1):
        ...
        for i, u in enumerate(spatial_frequency_range):
            # Multiply by binomial distribution
            transitions[j][i] *= binom.pmf(u, i, 0.5)  # Adjust the parameters of the binomial distribution as needed
